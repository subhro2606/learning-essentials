...
module.exports = function(apiClient) {
   ...
   * @param {Date} opts.beforeCreateTime Restrict the response to automations created before the set time. We recommend [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) time format: 2015-10-21T15:41:36+00:00.
   * @param {Date} opts.sinceCreateTime Restrict the response to automations created after the set time. We recommend [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) time format: 2015-10-21T15:41:36+00:00.
   * @param {Date} opts.beforeSendTime Restrict the response to automations sent before the set time. We recommend [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) time format: 2015-10-21T15:41:36+00:00.
   * @param {Date} opts.sinceSendTime Restrict the response to automations sent after the set time. We recommend [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) time format: 2015-10-21T15:41:36+00:00.
   ...
   * @param {String} workflowId The unique id for the Automation workflow.
   * @param {module:model/UpdateAnAutomation_} body 
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/AutomationWorkflow} and HTTP response
   */
  this.updateWithHttpInfo = function(workflowId, body) {
    var postBody = body;
   ...
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/AutomationWorkflow}
   */
  this.update = function(workflowId, body) {
    return this.updateWithHttpInfo(workflowId, body)
      .then(function(response_and_data) {
        return response_and_data.data;
      });
  }
