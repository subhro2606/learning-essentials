...
module.exports = function(apiClient) {
   ...
   * @param {Number} opts.count The number of records to return. [Default value](/developer/guides/get-started-with-mailchimp-api-3/#Parameters) is **10**. [Maximum value](/developer/guides/get-started-with-mailchimp-api-3/#Parameters) is **1000** (default to 10)
   * @param {Number} opts.offset The number of records from a collection to skip. Iterating over large collections with this parameter can be slow.  [Default value](/developer/guides/get-started-with-mailchimp-api-3/#Parameters) is **0**. (default to 0)
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CollectionOfExternalIdentifiers} and HTTP response
   */
  this.getListExternalIdsWithHttpInfo = function(listId, opts) {
    opts = opts || {};
    var postBody = null;
   ...
   * @param {Number} opts.count The number of records to return. [Default value](/developer/guides/get-started-with-mailchimp-api-3/#Parameters) is **10**. [Maximum value](/developer/guides/get-started-with-mailchimp-api-3/#Parameters) is **1000** (default to 10)
   * @param {Number} opts.offset The number of records from a collection to skip. Iterating over large collections with this parameter can be slow.  [Default value](/developer/guides/get-started-with-mailchimp-api-3/#Parameters) is **0**. (default to 0)
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CollectionOfExternalIdentifiers}
   */
  this.getListExternalIds = function(listId, opts) {
    return this.getListExternalIdsWithHttpInfo(listId, opts)
      .then(function(response_and_data) {
        return response_and_data.data;
      });
  }
   ...
   * @param {String} listId The unique ID for the list.
   * @param {Object} opts Optional parameters
   * @param {module:model/ExternalIdentifier1} opts.body 
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ExternalIdentifier} and HTTP response
   */
  this.createListExternalIdWithHttpInfo = function(listId, opts) {
    opts = opts || {};
    var postBody = opts['body'];
   ...
   * @param {Object} opts Optional parameters
   * @param {module:model/ExternalIdentifier1} opts.body 
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ExternalIdentifier}
   */
  this.createListExternalId = function(listId, opts) {
    return this.createListExternalIdWithHttpInfo(listId, opts)
      .then(function(response_and_data) {
        return response_and_data.data;
      });
  }
